...
public class JSONPost extends AsyncTask<String, String, String> {
   ...
   //     json=gson.toJson(checkoutInfo, CheckoutInfo.class);
   // }

    public JSONPost(JSONTask task,JSON_Customer customer){
        this.API=task;
        this.customer=customer;
        json=gson.toJson(this.customer,JSON_Customer.class);
    }
